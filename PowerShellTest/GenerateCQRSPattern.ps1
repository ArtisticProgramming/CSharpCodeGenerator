...
$BaseName = "TestCCG"
$BasedirctoryName="TestCCG"
#---DTO---
$DTOBasedirctoryName="TestCCG"
$ReturnDTOFileName="TestCCGReturn"
$EntryDTOFileName="TestCCGEntry"
...
$returnDto_fileDirectoryPath="\DTO\Models\"
...
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
# # ------------------------------------------------Entry DTO MODEL---------------------------------------
$entryDto_fileDirectoryPath="\DTO\Models\"+""
...
# ---------------------------------------- Crearting Queries Interfaces ------------------------------
$QueryInterface_dirctoryName =$BasedirctoryName
$QueryInterface_fileDirectoryPath="\Queries\Interfaces\"
...
# $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
# ---------------------------------------------- Crearting Queries Implementation ---------------------
