...
$BaseName = "AuditType"
#*****  DTO  *********
$ModelDTO_FileName="AuditTypeDto"
$ModelDB_FileName="AuditType"
...
$ModelInterface_fileFullName = $ModelInterface_fileDirectoryPath + "I"+$BaseName+".cs"
$ModelImplementation_fileFullName = $ModelImp_fileDirectoryPath + $BaseName+".cs"
#---------------
